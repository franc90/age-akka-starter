...
public class TopologyUpdateResponse implements Message {

    private final DirectedGraph<NodeId, DefaultEdge> topology;

    public TopologyUpdateResponse(DirectedGraph<NodeId, DefaultEdge> topology) {
    ...
    public boolean equals(Object o) {
        ...
        TopologyUpdateResponse that = (TopologyUpdateResponse) o;
