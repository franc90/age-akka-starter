...
public class NewTopologyResponse implements Message {

    private final DirectedGraph<NodeId, DefaultEdge> topology;

    public NewTopologyResponse(DirectedGraph<NodeId, DefaultEdge> topology) {
    ...
    public boolean equals(Object o) {
        ...
        NewTopologyResponse that = (NewTopologyResponse) o;
