...
public class UpdateWorkerTopologyRequest implements Message {

    private final DirectedGraph<NodeId, DefaultEdge> topology;

    public UpdateWorkerTopologyRequest(DirectedGraph<NodeId, DefaultEdge> topology) {
    ...
    public boolean equals(Object o) {
        ...
        UpdateWorkerTopologyRequest that = (UpdateWorkerTopologyRequest) o;
